...
Public KategorieIndex_Akt As String

Public DBdaten(23, 600)
Public DBdaten2(5, 600)

Public IndexX As Integer
Public Zaehler As Integer
Public Zaehler_Akt As Integer
Public XX As Integer
Public XX_Akt As Integer
Public NeuerIndex As Long
Public NeuerIndex_Akt As Long
...
Public Sub AbInDieDatenbank()
    ...
    Next XX
        ...
        DBdaten(10, NeuerIndex) = 0
        DBdaten(11, NeuerIndex) = 0
        DBdaten(12, NeuerIndex) = 0
        DBdaten(13, NeuerIndex) = 0
        DBdaten(14, NeuerIndex) = 0
...
End Sub
Public Sub AbInDieDatenbank_Akt()
    For XX_Akt = 0 To 500
    If DBdaten2(0, XX_Akt) = "" And DBdaten2(1, XX_Akt) = "" Then
    NeuerIndex_Akt = XX_Akt
    Exit For
    End If
    Next XX_Akt
    
        DBdaten2(0, NeuerIndex_Akt) = Left(frmAktivitaeten.Reise.Text, 2) 'KatalogNummer
        DBdaten2(1, NeuerIndex_Akt) = frmAktivitaeten.Datum.Text 'KatalogName
        DBdaten2(2, NeuerIndex_Akt) = frmAktivitaeten.Kosten.Text 'Name
        DBdaten2(3, NeuerIndex_Akt) = frmAktivitaeten.Akt.Text 'MEMO
        DBdaten2(4, NeuerIndex_Akt) = frmAktivitaeten.Notiz.Text 'MEMO
...
'Zähler
Zaehler_Akt = Zaehler_Akt + 1
        
' Aktualisieren
EinlesenEintraege_Akt
...
End Sub
Public Sub EinlesenEintraege_Akt()
Dim itmX As ListItem
Dim col As ColumnHeader
Dim XX2 As Integer
frmMain.ListView2.ColumnHeaders.Clear


    frmMain.ListView2.ColumnHeaders.Add , "Col1", "Art"
    frmMain.ListView2.ColumnHeaders.Add , "Col2", "Bezeichnung"
    frmMain.ListView2.ColumnHeaders.Add , "Col3", "Reiseziel"
    frmMain.ListView2.ColumnHeaders.Add , "Col4", "Index"

frmMain.ListView2.ColumnHeaders(1).Width = 1550
frmMain.ListView2.ColumnHeaders(2).Width = 1550
frmMain.ListView2.ColumnHeaders(3).Width = 1550
...
'frmMain.Answer.Text = ""
   ...
   For XX_Akt = 0 To Zaehler_Akt
        If DBdaten2(0, XX_Akt) = KategorieIndex_Akt And DBdaten2(1, XX_Akt) <> Empty Then
            Set itmX = frmMain.ListView2.ListItems.Add(, , DBdaten2(0, XX_Akt) & " " & DBdaten2(1, XX_Akt))
            itmX.SubItems(1) = DBdaten2(2, XX_Akt)   'Question
            itmX.SubItems(2) = DBdaten2(3, XX_Akt)   'Answer
            itmX.SubItems(2) = DBdaten2(4, XX_Akt)   'Answer
            itmX.SubItems(3) = XX_Akt   'index
          End If
    Next XX_Akt
...
frmOverview.ListView1.ListItems.Clear
   ...
   For XX = 0 To Zaehler - 1
        ...
        Wieviel = 0
            ...
            GesamtkostenList = GesamtkostenList + (DBdaten(10, XX)) + (DBdaten(11, XX)) + (DBdaten(12, XX)) + (DBdaten(13, XX)) + (DBdaten(14, XX))
            
            'GesamtbewertungList = GesamtbewertungList + ((Mid(DBdaten(19, XX), 1, 1)) + (Mid(DBdaten(20, XX), 1, 1)) + (Mid(DBdaten(21, XX), 1, 1)) + (Mid(DBdaten(22, XX), 1, 1)) + (Mid(DBdaten(23, XX), 1, 1))) / Wieviel
