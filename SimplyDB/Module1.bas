...
T = 0
frmMain.File.Open App.Path & "SimplyDB.dat", fsModeAppend
frmMain.File.Close

frmMain.File.Open App.Path & "SimplyDB.dat", fsModeInput, fsAccessRead, fsLockRead
...
frmMain.File.Open App.Path & "SimplyDB.dat", fsModeOutput, fsAccessWrite, fsLockReadWrite
...
T = 0
frmMain.File.Open App.Path & "SimplyDB_C.dat", fsModeAppend
frmMain.File.Close

frmMain.File.Open App.Path & "SimplyDB_C.dat", fsModeInput, fsAccessRead, fsLockRead
...
frmMain.File.Open App.Path & "SimplyDB_C.dat", fsModeOutput, fsAccessWrite, fsLockReadWrite
...
frmMain.File.Open App.Path & "Options.dat", fsModeAppend
frmMain.File.Close

frmMain.File.Open App.Path & "Options.dat", fsModeInput, fsAccessRead, fsLockRead
'On Error Resume Next
Do While Not frmMain.File.EOF
...
frmMain.File.Open App.Path & "Options.dat", fsModeOutput, fsAccessWrite, fsLockReadWrite
